...
import com.example.bedms.Patient.patientlistporterdetails;
import com.example.bedms.R;

import java.util.ArrayList;

public class PorterPatientAdapter extends RecyclerView.Adapter<PorterPatientAdapter.MyViewHolder> {
    ...
    public PorterPatientAdapter(ArrayList<Patient> myDataset) {
    ...
    @Override
    public PorterPatientAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), patientlistporterdetails.class);
