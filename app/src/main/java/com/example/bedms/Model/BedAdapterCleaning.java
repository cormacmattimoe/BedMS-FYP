...
public class BedAdapterCleaning extends RecyclerView.Adapter<BedAdapterCleaning.MyViewHolder> {
    ...
    public BedAdapterCleaning(ArrayList<Bed> myDataset) {
    ...
    @Override
    public BedAdapterCleaning.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
        // create a new view
