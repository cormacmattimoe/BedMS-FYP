...
public class AdminPatientAdapter extends RecyclerView.Adapter<AdminPatientAdapter.MyViewHolder> {
    ...
    public AdminPatientAdapter(ArrayList<Patient> myDataset) {
    ...
    @Override
    public AdminPatientAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                               int viewType) {
        // create a new view
