...
public class bedDetailsCleaner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beddetailscleaner);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.item1:
                ...
                Intent i = new Intent(bedDetailsCleaner.this, qrMainScreen.class);
                startActivity(i);
                return true;
            case R.id.item2:
                ...
                finish();
                Intent r = new Intent(bedDetailsCleaner.this, login.class);
                startActivity(r);
            default:
